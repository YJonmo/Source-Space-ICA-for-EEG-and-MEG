...
cfg.grid.unit       = 'mm';
cfg.channel = data.elec.label; %Only generate leadfields for good channels else will bug out later
grid = ft_prepare_leadfield(cfg);

%% Band-pass the data to clear some noises
cfg_filt = [] ;
cfg_filt.bpfilter = 'yes';
cfg_filt.bpfreq = [2 30] ;
[SensorData] = ft_preprocessing(cfg_filt, SensorData) ;
